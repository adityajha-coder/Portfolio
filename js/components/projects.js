...
function openAllProjectsModal(projects) {
    ...
    modal.innerHTML = `
        <div class="min-h-screen py-8 sm:py-12 px-4 sm:px-8 md:px-16 flex flex-col">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 max-w-6xl w-full mx-auto mb-8 sm:mb-10">
                <div>
                    <h2 class="text-2xl sm:text-3xl md:text-5xl font-bold text-white">Things I've Built.</h2>
                    <p class="text-xs sm:text-sm text-gray-400 mt-1 sm:mt-2">Each work showcases my passion towards tech and innovation</p>
                </div>
                <button id="close-projects-modal" class="self-end sm:self-auto px-4 sm:px-5 py-2 sm:py-2.5 glass-panel text-white hover:text-pink-400 rounded-full border border-white/10 hover:border-pink-500/40 transition-all active:scale-95 flex items-center gap-2 text-xs sm:text-sm font-semibold cursor-pointer">
                    <span>Close</span>
